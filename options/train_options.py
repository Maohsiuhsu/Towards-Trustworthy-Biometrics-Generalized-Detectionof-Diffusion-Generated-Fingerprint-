...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--earlystop_epoch', type=int, default=8)
        ...
        parser.add_argument('--fix_backbone', action='store_true', help='whethere to fix backbone or not')
        parser.add_argument('--dataset_mode', type=str, default='normal', help="to choose which dataset of DataLoader, the detail see the data/__init__.py")
        parser.add_argument('--pretrained_path', type=str, default=None, help="pretrained_weight and finetuining")
        self.isTrain = True
        return parser
